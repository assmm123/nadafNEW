...
class SupplierResource extends Resource
{
    ...
    {
        return $form->schema([
            Forms\Components\TextInput::make('name')->label('اسم المورد')->required()->maxLength(150),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('purchase_invoices_count')->label('الفواتير')->counts('purchaseInvoices'),
            ])
            ->actions([
